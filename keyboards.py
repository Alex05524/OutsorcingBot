...
def start_button_keyboard(admin=False):
    ...
    if admin:
        ...
        buttons.append([InlineKeyboardButton(text="📝 Общий список заявок", callback_data="show_all_orders")])
        buttons.append([InlineKeyboardButton(text="🌟 Добавить администратора", callback_data="add_admin")])
        buttons.append([InlineKeyboardButton(text="🗑️ Удалить администратора", callback_data="remove_admin")])
...
def services_keyboard():
    buttons = [
        ...
        [InlineKeyboardButton(text="🛠️ Предложения по монтажным работам", callback_data="service_2")],
        [InlineKeyboardButton(text="💲 Стоимость услуг", callback_data="show_price")],
